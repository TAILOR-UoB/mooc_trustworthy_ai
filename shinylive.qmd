...
# Formated text can be shown in the user interface with the shiny library
from shiny import App, ui

app_ui = ui.page_fluid(ui.h2("This is an html header (level 2) example"))
...
and its limitations in the Quarto publishing system.
