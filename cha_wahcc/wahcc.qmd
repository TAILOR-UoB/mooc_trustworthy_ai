...
subtitle: <a href="slides-cla-cal.html" target="_blank"><img src="https://img.shields.io/badge/Slides-Revealjs_(html)-yellow"></a> <a href="cla-cal-slides.pdf" target="_blank"><img src="https://img.shields.io/badge/Slides-LaTeX_Beamer_(pdf)-orange"></a>
author: 
  - name: Peter Flach
...
In the following example you can change the number of bins of a fixed set of
samples and see how the Expected Calibration Error changes accordingly.
...
- To calibrate these means to _pull predicted probabilities away from the centre_. 
...
- Calibrating these means to _push predicted probabilities toward the centre_. 
...
**Correct**. Platt scaling for probability scores can only generate S shaped
calibration maps, which can only calibrate under-confident scores.
:::
